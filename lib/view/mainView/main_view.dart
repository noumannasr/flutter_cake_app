                ...
                Container(
                  ...
                  child: Column(
                    ...
                    SizedBox(
                        ...
                        child:  provider.isLoading ? Center(child: CircularProgressIndicator()) : ScrollableListTabScroller.defaultComponents(
                          padding: EdgeInsets.zero,
                          headerContainerProps:
                          HeaderContainerProps(height: 60),
                          tabBarProps: TabBarProps(
                              dividerColor: Colors.red.withOpacity(0.0)),
                          itemCount: provider.finalData.length,
                              ...
                              Padding(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    gradient: LinearGradient(
                                      colors: active ? [AppColors.lightSecondaryColor1, AppColors.lightSecondaryColor2] : [AppColors.primaryColor,AppColors.lightSecondaryColor]
                                    )
                                  ),
                                  child: Padding(
                                    padding: EdgeInsets.symmetric(horizontal: 10, vertical: 5),
                                    child: Text(
                                      provider.finalData.keys.elementAt(index),
                                      style: !active
                                          ? null
                                          : TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: active ? AppColors.primaryColor : Colors.green),
                                    ),
                                  ),
                                ),
                              ),
                                  ...
                                  children: [
                                    ...
                                    ...provider.finalData.values
                                        ...
                                        ListTile(
                                          ...
                                          subtitle: Text(productModel.cockingTime),
