                          ...
                          : Center(
                              child: SizedBox(
                                height: mainVm.filteredList.isEmpty
                                    ? mainVm.searchController.text.isNotEmpty
                                        ? deviceHeight * 0.12
                                        : deviceHeight * 0.085
                                    : deviceHeight * 0.75,
                                ...
                                child: SearchableList<ProductModel>(
                                  ...
                                  searchFieldWidth: deviceWidth * 0.95,
                                  searchTextController: mainVm.searchController,
                                  sortPredicate: (a, b) =>
                                      a.productName.compareTo(b.productName),

                                  itemBuilder: (item) {
                                    return mainVm.filteredList.isNotEmpty
                                  ...
                                  filter: (keyword) {
                                    mainVm.updateFilteredList(keyword);
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(
                                  left: 10, bottom: 8, right: 10, top: 0),
                              child: Row(
                                mainAxisAlignment:
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      FirebaseAnalytics.instance.logEvent(name: 'See_all_categories');
                              ...
                              child: SizedBox(
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      final item = mainVm.categories[index];
                                      return CategoryItem(
                                        categoryModel: mainVm.categories[index],
                                        onTap: () {
                                          FirebaseAnalytics.instance
                                              .setUserProperty(
                                                  name: 'MainCategorySlider',
